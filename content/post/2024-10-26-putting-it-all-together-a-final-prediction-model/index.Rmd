...
\[
\underbrace{\text{pv2p}}_{\text{State-level incumbent party pv2p}} = \beta_0 + \beta_1 \cdot \underbrace{\text{G2GDP}}_{\text{State-level Q2 GDP growth}} + \beta_2 \cdot \underbrace{\text{NETAPP}}_{\text{State-level two-candidate poll}} + \beta_3 \cdot \underbrace{\text{TERM1INC}}_{\text{sitting president?}} + \beta_4 \cdot \underbrace{\text{LAG}}_{\text{State-level previous election pv2p}}
\]
