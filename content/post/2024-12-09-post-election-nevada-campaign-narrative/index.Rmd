...
[Sabato](https://centerforpolitics.org/crystalball/2024-president/) gave Nevada a "Lean Democrat", while [Cook] considered it a "Toss Up". In [538]'s simulations, Harris won 50 times out of 100. In my forecast, I predicted that Harris will win 48.17\% of the two-party vote, with a 95\% prediction interval of (44.40\%, 51.95\%).
...
# Campaign
Drawing on the news you have been following and other sources if necessary, briefly summarize the campaign in the state.  For example, you might consider the candidates and issues of “candidate quality” and the volume and content of their campaign, including the air and ground campaign, and the associated news coverage.  Particular examples can be useful here. Be sure to cite your sources.
